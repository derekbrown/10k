...
import { createMessengerFunctionStrategy } from './strategies/messenger.mjs';
...
function createEndpoint(initialMessenger, {
  ...
  function _listener() {
    _listener = _asyncToGenerator(function* (event) {
  ...
  function fromWire(value, retainedBy = []) {
    if (typeof value === 'object') {
      ...
      return Object.keys(value).reduce((object, key) => _objectSpread2(_objectSpread2({}, object), {}, {
