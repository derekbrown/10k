import { RELEASE_METHOD, RETAIN_METHOD, RETAINED_BY } from '../types.esnext';
import { isMemoryManageable, StackFrame } from '../memory.esnext';
      ...
      case APPLY:
        {
          ...
          try {
            ...
            const result = await func(...fromWire(args, retainedBy));
...
export { createMessengerFunctionStrategy };
