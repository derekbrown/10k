...
function workerBabelPlugin({
  ...
  function processBinding(binding, importOptions, state) {
    ...
    for (const referencePath of callingReferences) {
      ...
      const _options = _rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, getLoaderOptions(leadingComments || [])), {}, {
...
function normalize(packages) {
  return Object.keys(packages).reduce((all, pkg) => _rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, all), {}, {
