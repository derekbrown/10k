...
var Provider = function Provider(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(react.ChakraProvider, props, children);
};
...
var Address = function Address(_ref) {
  ...
  React.useEffect(function () {
    ...
    function _fetchEns() {
      _fetchEns = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee() {
        var ensResponse;
  ...
  return /*#__PURE__*/React__default["default"].createElement(react.FormControl, {
    ...
    onClick: handleClick
  }, /*#__PURE__*/React__default["default"].createElement(react.Text, null, ensName || displayAddress), copiable && /*#__PURE__*/React__default["default"].createElement(react.Box, {
    ml: "auto"
  }, copied ? /*#__PURE__*/React__default["default"].createElement(icons.CheckIcon, {
    color: "green.500"
  }) : /*#__PURE__*/React__default["default"].createElement(icons.CopyIcon, {
    color: "gray.300"
  }))), /*#__PURE__*/React__default["default"].createElement(react.FormErrorMessage, null, error));
};
...
var NFT = function NFT(_ref) {
  ...
  var fetchNFTData = React.useCallback( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee() {
  ...
  return /*#__PURE__*/React__default["default"].createElement(NFTCard, {
    data: nftData,
...
var NFTCard = function NFTCard(_ref3) {
  ...
  if (errorMessage || error || imageUrl === '(unknown)' || !imageUrl) {
    ...
    return /*#__PURE__*/React__default["default"].createElement(react.Alert, {
      status: "error"
    }, /*#__PURE__*/React__default["default"].createElement(react.AlertIcon, null), errorMessage);
  }

  return /*#__PURE__*/React__default["default"].createElement(react.Skeleton, {
    isLoaded: !!data,
    maxW: size,
    h: "md"
  }, /*#__PURE__*/React__default["default"].createElement(react.Box, {
    maxW: size,
    borderRadius: "lg",
    borderWidth: "1px",
    overflow: "hidden"
  }, animationUrl ? animationUrl.endsWith('.mp3') ? /*#__PURE__*/React__default["default"].createElement(react.VStack, null, /*#__PURE__*/React__default["default"].createElement(react.Image, {
    src: imageUrl,
    alt: displayName,
    borderRadius: "lg",
    w: size,
  ...
  }, displayName), assetContractSymbol && /*#__PURE__*/React__default["default"].createElement(react.Tag, {
    size: "sm"
  }, assetContractSymbol)), /*#__PURE__*/React__default["default"].createElement(react.Text, {
    fontSize: "xs"
...
var NFTGallery = function NFTGallery(_ref) {
  ...
  React.useEffect(function () {
    ...
    function _exec() {
      _exec = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee() {
  ...
  return /*#__PURE__*/React__default["default"].createElement(react.VStack, null, errorMessage && /*#__PURE__*/React__default["default"].createElement(react.Alert, {
    status: "error"
  }, /*#__PURE__*/React__default["default"].createElement(react.AlertIcon, null), errorMessage), /*#__PURE__*/React__default["default"].createElement(react.Grid, {
...
var AddressInput = function AddressInput(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(react.FormControl, {
    isInvalid: !!error
  }, label && /*#__PURE__*/React__default["default"].createElement(react.FormLabel, null, "Input address"), /*#__PURE__*/React__default["default"].createElement(react.Input, _extends({
    isInvalid: !!error,
    value: inputValue,
    onChange: function onChange(e) {
      return setInputValue(e.target.value);
    }
  }, props)), /*#__PURE__*/React__default["default"].createElement(react.FormErrorMessage, null, error ? ' ' + error : ''));
};
...
var EtherInput = function EtherInput(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(react.FormControl, {
    ...
    mb: "8px"
  }, label, ": ") : '', /*#__PURE__*/React__default["default"].createElement(react.InputGroup, props, /*#__PURE__*/React__default["default"].createElement(react.Input, {
    ...
    onChange: function onChange(e) {
      ...
      if (unit === 'ether') {
        _onChange(ethers.ethers.utils.parseEther(e.target.value).toString());
      } else {
        _onChange(e.target.value);
      }
    }
  }), showUnit && /*#__PURE__*/React__default["default"].createElement(react.InputRightAddon, null, unit === 'ether' ? 'Ξ' : 'wei')), error && /*#__PURE__*/React__default["default"].createElement(react.FormErrorMessage, null, error));
};
...
var TokenBalance = function TokenBalance(_ref) {
  ...
  var Headline = function Headline(name) {
    return /*#__PURE__*/React__default["default"].createElement(react.Heading, {
      as: "h3",
      size: "sm"
    }, name);
  };

  return /*#__PURE__*/React__default["default"].createElement(react.Flex, _extends({
    borderRadius: "lg",
    borderWidth: "1px",
    overflow: "hidden",
    px: "4",
    py: "2"
  }, props), /*#__PURE__*/React__default["default"].createElement(react.Box, {
    w: "50px",
    pr: "4"
  }, /*#__PURE__*/React__default["default"].createElement(react.Image, {
    src: imgUrl
    ...
    flex: "2"
  }, Headline(symbol), /*#__PURE__*/React__default["default"].createElement("p", null, name)), /*#__PURE__*/React__default["default"].createElement(react.Box, {
    flex: "1"
  }, Headline('Balance'), /*#__PURE__*/React__default["default"].createElement("p", null, balance)), /*#__PURE__*/React__default["default"].createElement(react.Box, {
    flex: "1"
  }, Headline('Value'), /*#__PURE__*/React__default["default"].createElement("p", null, "$", usdValue)));
};
...
var MultiAddressInput = function MultiAddressInput(_ref) {
  ...
  var addressBadge = function addressBadge(entry) {
    return /*#__PURE__*/React__default["default"].createElement(react.Box, {
      p: "1",
      key: entry.input
    }, /*#__PURE__*/React__default["default"].createElement(react.HStack, {
      spacing: 4
      ...
      borderRadius: "full",
      variant: "solid"
    }, /*#__PURE__*/React__default["default"].createElement(react.TagLabel, {
      color: entry.isValid ? 'default' : 'red.300'
    }, entry.input), /*#__PURE__*/React__default["default"].createElement(react.TagCloseButton, {
  ...
  var handleChange = function handleChange(e) {
    ...
    if (lastInput === ',' || lastInput === '\n') {
      var splitInput = e.currentTarget.value.split(/[ ,\n]+/).filter(function (c) {
        ...
        var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee(uin) {
          var val;
          return _regeneratorRuntime__default["default"].wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(react.VStack, null, /*#__PURE__*/React__default["default"].createElement(react.Wrap, null, value && value.map(addressBadge)), /*#__PURE__*/React__default["default"].createElement(react.Textarea, _extends({
    rows: 1,
    placeholder: placeholder,
    onChange: handleChange,
    disabled: isLoading
  }, inputProps)), isLoading && /*#__PURE__*/React__default["default"].createElement(react.Spinner, {
    size: "sm"
  }));
};
...
exports.MultiAddressInput = MultiAddressInput;
exports.NFT = NFT;
