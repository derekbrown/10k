...
const supportedTokens = [
  ...
  {name: "Bored Ape", contractAddress: "0xbc4ca0eda7647a8ab7c2061c2e118a18a936f13d"},
  {name: "Mutant Ape", contractAddress: "0x60e4d786628fea6478f785a6d7e704777c86a7c6"},
  ...
  {name: "DeadFellaz", contractAddress: "0x2acab3dea77832c09420663b0e1cb386031ba17b"},
...
function Tokens({number}) {
  return (
    <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-2 h-full w-full font-semibold">
